...
return {
	...
	TelescopeMatching = { fg = colour.tiger },
	...
	CmpItemAbbrMatch = { fg = colour.tiger },
	CmpItemAbbrMatchFuzzy = { fg = colour.tiger },
	CmpItemKindMatchFuzzy = { fg = colour.tiger },
	CmpDocumentation = { fg = colour.coral, bg = colour.raven },
	CmpItemAbbrMatchDefault = { fg = colour.tiger },
	CmpItemAbbrMatchFuzzyDefault = { fg = colour.tiger },
