...
return {
  ...
  DiagnosticVirtualTextError          = { fg = colour.rouge, bg = colour.blush, italic = true },
  DiagnosticVirtualTextHint           = { fg = colour.paris, bg = colour.green, italic = true },
  DiagnosticVirtualTextInfo           = { fg = colour.pearl, bg = colour.stone, italic = true },
  DiagnosticVirtualTextWarn           = { fg = colour.amber, bg = colour.orang, italic = true },
