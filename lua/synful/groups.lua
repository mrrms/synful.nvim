...
return {
	...
	Constant = { link = "Macro" },
	Cursor = { fg = colour.pearl, bg = colour.paris },
	CursorLine = {},
	...
	KeywordReturn = { fg = colour.paris, bold = true },
	Label = { link = "Macro" },
	...
	Repeat = { link = "Macro" },
	Return = { fg = colour.paris, bold = true },
	...
	typescriptDOMFormProp = { link = "@comment.documentation" },
