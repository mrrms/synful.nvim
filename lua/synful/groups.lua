...
return {
  ...
  DiagnosticUnderlineWarn             = { fg = colour.amber, bg = colour.peach, italic = true },
  DiagnosticVirtualTextWarn           = { fg = colour.peach, bg = colour.amber, underline = true },
  DiagnosticWarn                      = { fg = colour.peach, bg = colour.amber, bold = true },
  DiffAdd                             = { link = 'String' },
