...
return {
  ...
  DiagnosticUnderlineWarn             = { fg = 'Amber', bg = 'Peach', italic = true },
  DiagnosticVirtualTextWarn           = { fg = 'Peach', bg = 'Amber', underline = true },
  DiagnosticWarn                      = { fg = 'Peach', bg = 'Amber', bold = true },
  DiffAdd                             = { link = 'String' },
