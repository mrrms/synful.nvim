...
local editor_syntax = {
  ...
  CursorLineNr            = { fg = colors.pale_blue, bg = colors.deep_blue },
...
local lang_syntax = {
  ...
  TitleString                   = { bg = colors.freeze, fg = colors.zero_dark, gui = 'bold' },
  TitleSymbol                   = { bg = colors.zero_dark, fg = colors.freeze },
  TitleIcon                     = { bg = colors.freeze, fg = colors.red },
  SagaBorder                    = editor_syntax.FloatBorder,
  SagaExpand                    = { fg = colors.red },
  SagaCollapse                  = { fg = colors.red },
  SagaBeacon                    = { bg = colors.magenta },
  ActionPreviewTitle            = { fg = colors.purple, bg = colors.zero_dark },
  CodeActionText                = { fg = colors.yellow },
  CodeActionConceal             = { fg = colors.green },
  FinderSelection               = { fg = colors.pale_blue, gui = 'bold' },
  FinderFileName                = { fg = colors.white },
  FinderIcon                    = { fg = colors.pale_blue },
  FinderType                    = { fg = colors.purple },
  FinderSpinnerTitle            = { fg = colors.magenta, gui = 'bold' },
  FinderSpinner                 = { fg = colors.magenta, gui = 'bold' },
  FinderVirtText                = { fg = colors.red },
  RenameNormal                  = { fg = colors.orange, bg = colors.zero_dark },
  DiagnosticSource              = { fg = colors.grey },
  DiagnosticPos                 = { fg = colors.grey },
  DiagnosticWord                = { fg = colors.freeze },
  CallHierarchyIcon             = { fg = colors.purple },
  CallHierarchyTitle            = { fg = colors.red },
  SagaShadow                    = { bg = colors.zero_dark },
  OutlineIndent                 = { fg = colors.magenta },
  LspSagaLightBulb              = editor_syntax.DiagnosticHint,
  FinderCount                   = editor_syntax.Search,
  RenameMatch                   = editor_syntax.Search,
  FinderPreviewSearch           = editor_syntax.Search,
  DefinitionSearch              = editor_syntax.Search,
  OutlinePreviewBorder          = editor_syntax.FloatBorder,
  CallHierarchyNormal           = editor_syntax.FloatBorder,
  DiagnosticNormal              = editor_syntax.FloatBorder,
  DiagnosticBorder              = editor_syntax.FloatBorder,
  DiagnosticErrorBorder         = editor_syntax.FloatBorder,
  DiagnosticWarnBorder          = editor_syntax.FloatBorder,
  DiagnosticHintBorder          = editor_syntax.FloatBorder,
  DiagnosticInfoBorder          = editor_syntax.FloatBorder,
  ActionPreviewNormal           = editor_syntax.FloatBorder,
  ActionPreviewBorder           = editor_syntax.FloatBorder,
  CodeActionNormal              = editor_syntax.FloatBorder,
  CodeActionBorder              = editor_syntax.FloatBorder,
  FinderNormal                  = editor_syntax.FloatBorder,
  FinderBorder                  = editor_syntax.FloatBorder,
  FinderPreviewBorder           = editor_syntax.FloatBorder,
  DefinitionBorder              = editor_syntax.FloatBorder,
  DefinitionNormal              = editor_syntax.FloatBorder,
  HoverNormal                   = editor_syntax.FloatBorder,
  HoverBorder                   = editor_syntax.FloatBorder,
  RenameBorder                  = editor_syntax.FloatBorder,
  CallHierarchyBorder           = editor_syntax.FloatBorder,
  OutlinePreviewNormal          = editor_syntax.FloatBorder,
