...
local plugin_syntax = {
  ...
  NotifyDEBUGBorder     = { fg = vim.g.dolphin },
  ...
  NotifyDEBUGIcon       = { fg = vim.g.dolphin },
  NotifyDEBUGTitle      = { fg = vim.g.dolphin },
...
local lang_syntax = {
  ...
  jsxExpressionBlock             = { fg = vim.g.dolphin },
  ...
  typescriptTemplate             = { fg = vim.g.dolphin, gui = 'italic' },
