...
local editor_syntax = {
  ...
  TabLineSel                   = { fg = zero_dark, bg = deep, gui = 'bold', },
  TelescopeSelection           = { fg = freeze, bg = deep, gui = 'bold' },
  ...
  CmpItemAbbrMatch             = { fg = magenta, gui = 'bold' },
  TelescopeMatching            = { fg = magenta, gui = 'bold' },
  LspSagaRenameMatch           = { fg = magenta, gui = 'bold' },
  CmpItemAbbrMatchFuzzy        = { fg = magenta, gui = 'bold' },
  CmpItemKindMatchFuzzy        = { fg = magenta, gui = 'bold' },
  TelescopePreviewMatch        = { fg = magenta, gui = 'bold' },
  CmpItemAbbrMatchDefault      = { fg = magenta, gui = 'bold' },
  CmpItemAbbrMatchFuzzyDefault = { fg = magenta, gui = 'bold' },
  Title                        = { fg = white },
...
local lang_syntax = {
  ...
  jsObject              = { fg = death },
  jsBrackets            = { fg = death },
  jsTernaryIf           = { fg = magenta },
  jsTernaryOperator     = { fg = magenta },
  ...
  jsObjectObjectProp    = { fg = magenta, gui = 'italic' },
  ...
  CmpItemKindProperty   = { fg = magenta },
