...
local code_syntax = {
  ...
  StorageClass               = { fg = rouge, gui = 'italic' },
  String                     = { fg = pale_green, gui = 'italic' },
  Structure                  = { fg = mauve, gui = 'italic' },
  Tag                        = { fg = orange },
...
local lang_syntax = {
  ...
  tsxAttrib                     = editor_syntax.LineNr,
  ...
  typescriptArray               = editor_syntax.LineNr,
  ...
  typescriptBlock               = editor_syntax.LineNr,
  typescriptBraces              = editor_syntax.LineNr,
  typescriptCall                = editor_syntax.LineNr,
  ...
  tsxEscapeJs                   = editor_syntax.LineNr,
  ...
  typescriptProp                = editor_syntax.Whitespace,
  ...
  CodeActionConceal             = { fg = green },
  FinderSelection               = { fg = pale_blue, gui = 'bold' },
  FinderFileName                = { fg = freeze },
  FinderIcon                    = { fg = pale_blue },
  FinderType                    = { fg = mauve },
