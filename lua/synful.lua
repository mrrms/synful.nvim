...
local editor_syntax = {
  ...
  gitcommitBranch         = { fg = mauve, gui = 'bold' },
  gitcommitNoBranch       = { fg = mauve },
...
local code_syntax = {
  ...
  Statement                  = { fg = freeze, gui = 'bold' },
  StorageClass               = { fg = mauve, gui = 'italic' },
  ...
  TelescopeMatching          = { fg = mauve, gui = 'bold' },
...
local lang_syntax = {
  ...
  tmuxVariableExtension         = { fg = mauve },
